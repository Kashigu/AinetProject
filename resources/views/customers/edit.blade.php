...
@section('main')
    <form id="form_criarImage" method="POST" action="{{ route('customer.update', ['customer' => $customer]) }}"
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mt-4 price-details">
                    <div class="col-md-6 mt-4 alinhaTextoCentro" style="justify-content: center">
                        <label><h3>Nif:</h3></label>
                        <br>
                        <input type="text" placeholder="nif" name="nif" value="{{ $customer->nif }}">
                    </div>
                    <div class="col-md-6 mt-4 alinhaTextoCentro">
            ...
            <div class="row mt-4 alinhaTextoCentro">
                <div class="col-md-12 d-flex justify-content-between">
                    <a href="{{route('user.show',['user' => $customer])}}"
